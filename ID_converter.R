...
parser$add_argument("-n","--col-num", type='integer', help="specify the number of column which has gene_id, default is 1",
                    default=1)
...
#args = parser$parse_args(c("--header","--output", "C:/Users/dlsrnsi/Documents/csbl toolbox/test.txt" ,"--col-num","4","ensembl_gene_id", "hgnc_symbol", "C:/Users/dlsrnsi/Documents/csbl toolbox/SE.hg19.isoform_result.csv"))
...
result_df = merge(gene_df, converted_ids, by.x = 4, by.y = original_type)
